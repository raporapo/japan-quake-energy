...
8px base spacing system with fine-grained sub-8px increments (1.5px, 2px, 2.5px, 3px, 4px, 5px, 6px) 2. Color Palette & Roles
Primary
...
Ambient Shadow (rgba(0,0,0,0.02) 0px 0px 16px, rgba(0,0,0,0.008) 0px 0px 8px): Subtle ambient glow for floating elements. 3. Typography Rules
Font Family
...
Weight restraint: CursorGothic uses weight 400 almost exclusively, relying on size and tracking for hierarchy rather than weight. System-ui components use 500-700 for functional emphasis. 4. Component Stylings
Buttons
...
CTA buttons with accent orange or primary dark styling 5. Layout Principles
Spacing System
Base unit: 8px
...
Full Pill (33.5M px / 9999px): Pill buttons, tags, badges 6. Depth & Elevation
Level Treatment Use
...
No harsh divider lines -- section separation through background tone shifts and spacing 7. Interaction & Motion
Hover States
...
Transform: subtle scale or translate for interactive feedback 8. Responsive Behavior
Breakpoints
...
Full-width hero images scale proportionally 9. Agent Prompt Guide
